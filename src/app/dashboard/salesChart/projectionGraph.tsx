...
export default function ProjectionGraph(props: { invoices: YearData[], receipts: YearData[], graphId: string }) {
...
const areaCombinedComponents = [
  ...props.invoices.map((yearData) => (
    <Area 
      ...
      type="monotone" 
      dataKey="totalAmount" 
      stroke="#2196f3"  // Green for invoices
      ...
      <defs>
        {props.invoices.map((yearData) => (
          <linearGradient
            ...
            y2="100%"
          >
            <stop offset="0%" stopColor="#2196f3" stopOpacity={0.8} /> {/* Green color for invoices */}
