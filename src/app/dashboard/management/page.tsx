...
import { Box, Info, Pill, Receipt, Store, Truck, User } from "lucide-react"
...
export default function Page() {
  return (
    <Tabs defaultValue="stock" className="">
      ...
      <TabsList className="sm:grid w-full sm:grid-cols-7">
      {tokenise()[4]=="admin" && <TabsTrigger value="user" className="p-2 border-none"><User size={16} className="mr-2"/>Users</TabsTrigger>}
        ...
        <TabsTrigger value="packaging" className="p-2 border-none"><Box size={16} className="mr-2"/>Packaging</TabsTrigger>
        <TabsTrigger value="notifications" className="p-2 border-none"><Info size={16} className="mr-2"/>Notifications</TabsTrigger>
        </TabsList>
